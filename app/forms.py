...
from wtforms import (BooleanField, FormField, IntegerField, SelectField,
...
class MotherboardForm(BaseComponentForm):
    ...
    socket_type_id = SelectField('Socket Type', coerce=int,
                                 validators=[DataRequired()])
    memory_type_id = SelectField('Memory Type', coerce=int,
                                 validators=[DataRequired()])
