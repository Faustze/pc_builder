...
base_component_model = components_ns.model('BaseComponent', {
...
motherboard_model = components_ns.inherit('Motherboard', base_component_model, {
...
cpu_model = components_ns.inherit('CPU', base_component_model, {
    'socket_type_id': fields.Integer(required=True, description='ID типа сокета'),
...
gpu_model = components_ns.inherit('GPU', base_component_model, {
    'vram': fields.Integer(required=True, description='Объем видеопамяти в ГБ')
})

ram_model = components_ns.inherit('RAM', base_component_model, {
    'memory_type_id': fields.Integer(required=True, description='ID типа памяти'),
...
soundcard_model = components_ns.inherit('Soundcard', base_component_model, {
    'channels_quantity': fields.Integer(required=True, description='Количество каналов')
})

motherboard_input = components_ns.model('MotherboardInput', {
    'brand_id': fields.Integer(required=True, description='ID бренда'),
    'model': fields.String(required=True, description='Модель'),
    'quantity': fields.Integer(required=True, description='Количество'),
    'socket_type_id': fields.Integer(required=True, description='ID типа сокета'),
...
cpu_input = components_ns.model('CPUInput', {
    'brand_id': fields.Integer(required=True, description='ID бренда'),
    'model': fields.String(required=True, description='Модель'),
    'quantity': fields.Integer(required=True, description='Количество'),
    'socket_type_id': fields.Integer(required=True, description='ID типа сокета'),
...
gpu_input = components_ns.model('GPUInput', {
    'brand_id': fields.Integer(required=True, description='ID бренда'),
    'model': fields.String(required=True, description='Модель'),
    'quantity': fields.Integer(required=True, description='Количество'),
    'vram': fields.Integer(required=True, description='Объем видеопамяти в ГБ')
...
ram_input = components_ns.model('RAMInput', {
    'brand_id': fields.Integer(required=True, description='ID бренда'),
    'model': fields.String(required=True, description='Модель'),
    'quantity': fields.Integer(required=True, description='Количество'),
    'memory_type_id': fields.Integer(required=True, description='ID типа памяти'),
...
soundcard_input = components_ns.model('SoundcardInput', {
    'brand_id': fields.Integer(required=True, description='ID бренда'),
    'model': fields.String(required=True, description='Модель'),
    'quantity': fields.Integer(required=True, description='Количество'),
    'channels_quantity': fields.Integer(required=True, description='Количество каналов')
...
class MotherboardAddResource(Resource):
    ...
    @components_ns.marshal_with(motherboard_model, code=201)  # type: ignore
...
class CPUAddResource(Resource):
    ...
    @components_ns.marshal_with(cpu_model, code=201)  # type: ignore
...
class GPUAddResource(Resource):
    ...
    @components_ns.marshal_with(gpu_model, code=201)  # type: ignore
...
class RAMAddResource(Resource):
    ...
    @components_ns.marshal_with(ram_model, code=201)  # type: ignore
...
class SoundcardAddResource(Resource):
    ...
    @components_ns.marshal_with(soundcard_model, code=201)  # type: ignore
